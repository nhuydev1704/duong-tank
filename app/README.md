...
- ### Splash
  ...
  - Create new script in `package.json` file. ex:
    - `"splash-demo": "node ./scripts/splash.js splash/splash-demo.png 0E1019 150 demo BootSplashDemo",`
      ...
      - Open `demo.xcworkspace` via xcode then add `BootSplashDemo.storyboad` file to xcode.
...
- ### IOS
  ...
  - Open Open `demo.xcworkspace` via xcode
  - Select `demo-Dev` scheme then click edit scheme
  - Click Duplicate scheme.
  - Rename Scheme like: `demo-<SCHEME_SUFFIX>`. `SCHEME_SUFFIX` in env file
